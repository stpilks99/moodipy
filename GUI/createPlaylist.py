...
Done = Button(createPlaylist, text = "Done", bg ="green", width = 20, height = 6)
Done.place(x = 710,y = 530)

#creates cancel button that brings back to homepage
Cancel = Button(createPlaylist, text = "Cancel", bg ="green", width = 20, height = 6)
...
lt = tk.Label(createPlaylist, text ='Playlist title:', fg = "black", bg = "green", font = "Helvetica 20 bold italic")
...
Lp = tk.Label(createPlaylist, text = "Select time period:", fg = "black", bg = "green", font = "Helvetica 21 bold italic")
...
Lp = tk.Label(createPlaylist, text = "Enter preferred artist:", fg = "black", bg = "green", font = "Helvetica 20 bold italic")
...
La = tk.Label(createPlaylist, text = "Enter preferred genres:", fg = "black", bg = "green", font = "Helvetica 20 bold italic")
La.place(x = 150, y = 390)

#creates a drop down list where the user can select yes for explict or no for non explicit
La = tk.Label(createPlaylist, text = "Would you like explict songs:", fg = "black", bg = "green", font = "Helvetica 20 bold italic")
